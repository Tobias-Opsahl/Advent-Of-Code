# Advent of code 2022 december the 11th, 2nd exercise
...
class Monkey:
    ...
    def advance(self):
        ...
        for item in self.items:  # Inspect and throw all items, one at a time
            ...
            # item = int(item / 3)  # Decrease worry level (Not in 11.2)
    ...
    def throw_to_monkey(self, item):
        ...
        """
        item = item % self.div  # 11.2: Divide by shared divisor
...
rounds = 10000
divisor = 1  # Find shared divisor among all monkeys
